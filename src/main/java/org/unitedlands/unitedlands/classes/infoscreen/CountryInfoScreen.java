...
public class CountryInfoScreen extends InfoScreen {
        ...
        public CountryInfoScreen(UnitedLands plugin, IMessageProvider messageProvider, Country country) {
                ...
                // var board = Messenger.getMessage(messageProvider.get("info-screens.country.board"), Map.of("board",
                ...
                //                                                         .toList()));
                // }
                // var citizens = Messenger.getMessage(messageProvider.get("info-screens.country.citizens"),
                ...
                // var sizeupkeep = Messenger.getMessage(messageProvider.get("info-screens.country.sizeupkeep"),
