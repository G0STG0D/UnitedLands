...
@UnitedSubCommand(
        ...
        name = "permission",
        description = "Sets settlement permissions",
        usage = "/settlement permission <permission> <group> <on|off>",
        catchAll = true,
        playerOnly = true
)
public class CmdSettlementPermission extends SettlementCommandHandler {
