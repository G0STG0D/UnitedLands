    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        switch (args[1]) {
            ...
            case "foreigners":
                ...
                break;
            default:
                Messenger.sendMessage(context.player(), MessageProvider.instance().get(Message.PLAYER__REGION__PERMISSION__UNKNOWN_MEMBERSHIP.path()),
        ...
        switch (args[0]) {
            ...
            case "interact":
                ...
                break;
            default:
                Messenger.sendMessage(context.player(), MessageProvider.instance().get(Message.PLAYER__REGION__PERMISSION__UNKNOWN_PERMISSION.path()),
                        Map.of("permission", args[0]), MessageProvider.instance().get(Message.PREFIX.path()));
                return;
        }

        Messenger.sendMessage(context.player(), MessageProvider.instance().get(Message.PLAYER__REGION__PERMISSION__SUCCESS.path()), Map.of(
                "permission", args[0],
                "membership", args[0],
