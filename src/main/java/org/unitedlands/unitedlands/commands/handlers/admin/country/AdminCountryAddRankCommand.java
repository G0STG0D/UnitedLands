...
public class AdminCountryAddRankCommand extends CountryAdminCommandHandler {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        if (args.length != 3) {
            Messenger.sendMessage(sender, messageProvider.get(Message.ADMIN__COUNTRY__ADDRANK__USAGE.path()), null, messageProvider.get(Message.PREFIX.path()));
            return;
        }
        ...
        Messenger.sendMessage(sender, messageProvider.get(Message.ADMIN__COUNTRY__ADDRANK__SUCCESS.path()),
